...
(function($) {
	"use strict";
		...
		//Image Background
		// $(".image-background").backstretch("images/GGJ17-CoverImage-Twitter-1500x500.png");
		...
		$('#clock-countdown').countdown('2017/1/20 17:00:00').on('update.countdown', function(event) {
